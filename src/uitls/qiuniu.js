...
export let option = {
  ...
  SK: 'ITdGHHdXeCle1T_zQ37FXYtB5YdvswA1vDwtT_DW', //七牛SK
  bucketName: 'tiangongyun-test', //七牛桶名称
  url: 'https://up-z2.qiniup.com', //七牛API地址
  static: 'http://testimg.tiangongy.com' //静态域名访问地址
};
